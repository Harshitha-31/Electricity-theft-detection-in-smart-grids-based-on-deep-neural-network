...
main = tkinter.Tk()
main.title("Electricity Theft Detection in Smart Grids based on Deep Neural Network") 
...
font = ('times', 16, 'bold')
title = Label(main, text='Electricity Theft Detection in Smart Grids based on Deep Neural Network', justify=LEFT)
